...
Try {
	...
	[string]$appScriptDate = '06/08/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles\DellDockingStationFwUp_1.0.4.exe" -Parameters '/s' -WindowStyle 'Hidden'
		Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\MSUDenver" -Name "WD15Firmware" -Value '1.0.4' -Type String
